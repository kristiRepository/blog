...
<div class="card-header">Articles</div>
      ...
      <table class="table">
        ...
        <?php foreach($articles as $article){ ?>
          ...
          <td><?php if($article['is_feature']) echo 'yes';else{echo 'no';}  ?></td>
          <td><?php echo $article['username'];  ?></td>
          <td><?php foreach($article_tags as $article_tag){ if($article['id']==$article_tag['article_id'] ){echo $article_tag['tag_name']." ";}} ?></td>
