        ...
        <div class="login-form">
            ...
            <form action="/check" method="POST">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="username" required value=<?php if (isset($_COOKIE['username'])) {
                                                                                                echo $_COOKIE['username'];
                                                                                            }  ?>>
                </div>
                <div class="form-group">
                    <label for="password">Password</label>
                    <input class="form-control" type="password" name="password" required value=<?php if (isset($_COOKIE['password'])) {
